<select class="form-control" name="nationality" value="<?= isset($_POST['nationality']) ? $_POST['nationality'] : '' ?>"class="form-control <?= isset($formErrors['nationality']) ? 'is-invalid' : (isset($nationality) ? 'is-valid' : '') ?>" id="nationality" required>
    <option disabled selected hidden>Sélectionner un pays</option>  
